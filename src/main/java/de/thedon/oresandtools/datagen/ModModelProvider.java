...
public class ModModelProvider extends ModelProvider {
    ...
    protected void registerModels(BlockModelGenerators blockModels, ItemModelGenerators itemModels) {
        ...
        /* ARMOR */
        itemModels.generateTrimmableItem(ModItems.COPPER_HELMET.get(), ModEquipmentAssets.COPPER, "copper", false);
        itemModels.generateTrimmableItem(ModItems.COPPER_CHESTPLATE.get(), ModEquipmentAssets.COPPER, "copper", false);
        itemModels.generateTrimmableItem(ModItems.COPPER_LEGGINGS.get(), ModEquipmentAssets.COPPER, "copper", false);
        itemModels.generateTrimmableItem(ModItems.COPPER_BOOTS.get(), ModEquipmentAssets.COPPER, "copper", false);
        itemModels.generateTrimmableItem(ModItems.STEEL_HELMET.get(), ModEquipmentAssets.STEEL, "steel", false);
        itemModels.generateTrimmableItem(ModItems.STEEL_CHESTPLATE.get(), ModEquipmentAssets.STEEL, "steel", false);
        itemModels.generateTrimmableItem(ModItems.STEEL_LEGGINGS.get(), ModEquipmentAssets.STEEL, "steel", false);
        itemModels.generateTrimmableItem(ModItems.STEEL_BOOTS.get(), ModEquipmentAssets.STEEL, "steel", false);
        itemModels.generateTrimmableItem(ModItems.VALYRIAN_HELMET.get(), ModEquipmentAssets.VALYRIAN, "valyrian", false);
        itemModels.generateTrimmableItem(ModItems.VALYRIAN_CHESTPLATE.get(), ModEquipmentAssets.VALYRIAN, "valyrian", false);
        itemModels.generateTrimmableItem(ModItems.VALYRIAN_LEGGINGS.get(), ModEquipmentAssets.VALYRIAN, "valyrian", false);
        itemModels.generateTrimmableItem(ModItems.VALYRIAN_BOOTS.get(), ModEquipmentAssets.VALYRIAN, "valyrian", false);
        itemModels.generateTrimmableItem(ModItems.HARDENED_DIAMOND_HELMET.get(), ModEquipmentAssets.H_DIAMOND, "hardened_diamond", false);
        itemModels.generateTrimmableItem(ModItems.HARDENED_DIAMOND_CHESTPLATE.get(), ModEquipmentAssets.H_DIAMOND, "hardened_diamond", false);
        itemModels.generateTrimmableItem(ModItems.HARDENED_DIAMOND_LEGGINGS.get(), ModEquipmentAssets.H_DIAMOND, "hardened_diamond", false);
        itemModels.generateTrimmableItem(ModItems.HARDENED_DIAMOND_BOOTS.get(), ModEquipmentAssets.H_DIAMOND, "hardened_diamond", false);
        itemModels.generateTrimmableItem(ModItems.HOT_HARDENED_DIAMOND_HELMET.get(), ModEquipmentAssets.HOT_H_DIAMOND, "hot_hardened_diamond", false);
        itemModels.generateTrimmableItem(ModItems.HOT_HARDENED_DIAMOND_CHESTPLATE.get(), ModEquipmentAssets.HOT_H_DIAMOND, "hot_hardened_diamond", false);
        itemModels.generateTrimmableItem(ModItems.HOT_HARDENED_DIAMOND_LEGGINGS.get(), ModEquipmentAssets.HOT_H_DIAMOND, "hot_hardened_diamond", false);
        itemModels.generateTrimmableItem(ModItems.HOT_HARDENED_DIAMOND_BOOTS.get(), ModEquipmentAssets.HOT_H_DIAMOND, "hot_hardened_diamond", false);
        itemModels.generateTrimmableItem(ModItems.EMERALD_HELMET.get(), ModEquipmentAssets.EMERALD, "emerald", false);
        itemModels.generateTrimmableItem(ModItems.EMERALD_CHESTPLATE.get(), ModEquipmentAssets.EMERALD, "emerald", false);
        itemModels.generateTrimmableItem(ModItems.EMERALD_LEGGINGS.get(), ModEquipmentAssets.EMERALD, "emerald", false);
        itemModels.generateTrimmableItem(ModItems.EMERALD_BOOTS.get(), ModEquipmentAssets.EMERALD, "emerald", false);
        itemModels.generateTrimmableItem(ModItems.OBSIDIAN_HELMET.get(), ModEquipmentAssets.OBSIDIAN, "obsidian", false);
        itemModels.generateTrimmableItem(ModItems.OBSIDIAN_CHESTPLATE.get(), ModEquipmentAssets.OBSIDIAN, "obsidian", false);
        itemModels.generateTrimmableItem(ModItems.OBSIDIAN_LEGGINGS.get(), ModEquipmentAssets.OBSIDIAN, "obsidian", false);
        itemModels.generateTrimmableItem(ModItems.OBSIDIAN_BOOTS.get(), ModEquipmentAssets.OBSIDIAN, "obsidian", false);
