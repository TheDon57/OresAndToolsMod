...
public class ModPlacedFeatures {
    public static final ResourceKey<PlacedFeature> ORE_OBSIDIAN_LARGE_PLACED_KEY = registerKey("ore_obsidian_large");
    public static final ResourceKey<PlacedFeature> ORE_OBSIDIAN_MIDDLE_PLACED_KEY = registerKey("ore_obsidian_middle");
    public static final ResourceKey<PlacedFeature> ORE_OBSIDIAN_SMALL_PLACED_KEY = registerKey("ore_obsidian_small");
