...
public class ModBiomeModifiers {
    ...
    public static final ResourceKey<BiomeModifier> ADD_VALYRIAN_ORE = registerKey("add_valyrian_ore");
    public static final ResourceKey<BiomeModifier> ADD_END_VALYRIAN_ORE = registerKey("add_end_valyrian_ore");
    ...
    public static void bootstrap(BootstrapContext<BiomeModifier> context) {
        ...
        context.register(ADD_VALYRIAN_ORE, new BiomeModifiers.AddFeaturesBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_OVERWORLD),
                HolderSet.direct(placedFeatures.getOrThrow(ModPlacedFeatures.ORE_VALYRIAN_LARGE_PLACED_KEY),
                                 placedFeatures.getOrThrow(ModPlacedFeatures.ORE_VALYRIAN_MIDDLE_PLACED_KEY),
                                 placedFeatures.getOrThrow(ModPlacedFeatures.ORE_VALYRIAN_SMALL_PLACED_KEY)),
                GenerationStep.Decoration.UNDERGROUND_ORES));

        context.register(ADD_END_VALYRIAN_ORE, new BiomeModifiers.AddFeaturesBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_END),
                HolderSet.direct(placedFeatures.getOrThrow(ModPlacedFeatures.ORE_END_VALYRIAN_LARGE_PLACED_KEY),
                                 placedFeatures.getOrThrow(ModPlacedFeatures.ORE_END_VALYRIAN_MIDDLE_PLACED_KEY),
                                 placedFeatures.getOrThrow(ModPlacedFeatures.ORE_END_VALYRIAN_SMALL_PLACED_KEY)),
                GenerationStep.Decoration.UNDERGROUND_ORES));
