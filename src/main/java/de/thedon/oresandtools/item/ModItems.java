...
public class ModItems {
    ...
    public static final DeferredItem<Item> HARDENED_DIAMOND = ITEMS.registerItem("hardened_diamond", properties -> new ModItem(properties, true));
    ...
    public static final DeferredItem<Item> OBSIDIAN_SHARD = ITEMS.registerItem("obsidian_shard", Item::new);
    ...
    public static final DeferredItem<Item> HARDENED_DIAMOND_HELMET = ITEMS.registerItem("hardened_diamond_helmet", properties -> new ModArmorItem(ModArmorMaterials.H_DIAMOND, ArmorType.HELMET, properties));
    public static final DeferredItem<Item> HARDENED_DIAMOND_CHESTPLATE = ITEMS.registerItem("hardened_diamond_chestplate", properties -> new ModArmorItem(ModArmorMaterials.H_DIAMOND, ArmorType.CHESTPLATE, properties));
    public static final DeferredItem<Item> HARDENED_DIAMOND_LEGGINGS = ITEMS.registerItem("hardened_diamond_leggings", properties -> new ModArmorItem(ModArmorMaterials.H_DIAMOND, ArmorType.LEGGINGS, properties));
    public static final DeferredItem<Item> HARDENED_DIAMOND_BOOTS = ITEMS.registerItem("hardened_diamond_boots", properties -> new ModArmorItem(ModArmorMaterials.H_DIAMOND, ArmorType.BOOTS, properties));
    public static final DeferredItem<Item> OBSIDIAN_HELMET = ITEMS.registerItem("obsidian_helmet", properties -> new ModArmorItem(ModArmorMaterials.OBSIDIAN, ArmorType.HELMET, properties));
    public static final DeferredItem<Item> OBSIDIAN_CHESTPLATE = ITEMS.registerItem("obsidian_chestplate", properties -> new ModArmorItem(ModArmorMaterials.OBSIDIAN, ArmorType.CHESTPLATE, properties));
    public static final DeferredItem<Item> OBSIDIAN_LEGGINGS = ITEMS.registerItem("obsidian_leggings", properties -> new ModArmorItem(ModArmorMaterials.OBSIDIAN, ArmorType.LEGGINGS, properties));
    public static final DeferredItem<Item> OBSIDIAN_BOOTS = ITEMS.registerItem("obsidian_boots", properties -> new ModArmorItem(ModArmorMaterials.OBSIDIAN, ArmorType.BOOTS, properties));
