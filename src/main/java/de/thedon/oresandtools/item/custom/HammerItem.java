...
public class HammerItem extends ModItem {
    ...
    public HammerItem(ToolMaterial material, Properties properties, boolean withToolTip) {
    ...
    public HammerItem(ToolMaterial material, float attackDamage, float attackSpeed, Properties properties, boolean withToolTip) {
